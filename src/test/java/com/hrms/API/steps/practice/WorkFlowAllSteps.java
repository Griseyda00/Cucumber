...
import com.hrms.API.utils.copy.APIConstants;
import com.hrms.API.utils.copy.PayloadConstants;
...
public class WorkFlowAllSteps {
	...
	public void a_request_is_prepared_to_create_an_employee() {
		request = given().header("Content-Type", "application/json").header("Authorization", TokenGenerateToken.token)
